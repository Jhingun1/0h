      ...
      <div className="container max-w-3xl">
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="relative z-10">
            <p className="mb-3 text-sm font-normal uppercase tracking-[0.06em] text-[#273951] md:mb-4">
              {tagline}
            </p>
            <h2 className="mb-5 text-4xl font-light leading-[1.1] tracking-[-0.64px] text-[#061b31] md:mb-6 md:text-6xl lg:text-7xl">
              {heading}
            </h2>
            <p className="max-w-xl text-[#64748d] md:text-md">{description}</p>
...
const TimelineItem = ({ item }: { item: TimelineItemType }) => {
  ...
  return (
    <div className="relative">
      ...
      <div className="ml-4 mt-4 flex flex-col rounded-[8px] border border-[#e5edf5] bg-white p-5 shadow-[rgba(50,50,93,0.25)_0px_30px_45px_-30px,rgba(0,0,0,0.1)_0px_18px_36px_-18px] md:ml-12 md:p-7">
        <h3 className="mb-2 text-2xl font-light tracking-[-0.22px] text-[#533afd] md:text-3xl">
          {item.heading}
        </h3>
        <h4 className="mb-3 text-xl font-light tracking-[-0.22px] text-[#061b31] md:mb-4 md:text-2xl">{item.title}</h4>
        <p className="text-[#64748d]">{item.description}</p>
        <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
